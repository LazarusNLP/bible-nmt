...
#     --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engwyc2017-dhao/parallel_full" \
...
python run_post_editing.py \
    ...
    --src_lang_name ${SRC_LANG_NAME} \
    --tgt_lang_name ${TGT_LANG_NAME} \
    --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engwyc2017-dhao/parallel_nt" \
    --prompt "dhao_post_editing" \
    --few_shot_mode "parallel" \
    --vectorizer "word_parallel" \
...
#     --src_lang_name ${SRC_LANG_NAME} \
#     --tgt_lang_name ${TGT_LANG_NAME} \
#     --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engwyc2017-dhao/parallel_full+nt" \
#     --prompt "dhao_post_editing" \
#     --few_shot_mode "parallel" \
#     --vectorizer "word_parallel" \
...
#     --src_lang_name ${SRC_LANG_NAME} \
#     --tgt_lang_name ${TGT_LANG_NAME} \
#     --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engwyc2018-dhao/parallel_full" \
#     --prompt "dhao_post_editing" \
#     --few_shot_mode "parallel" \
#     --vectorizer "word_parallel" \
#     --few_shot_corpus_path ${ADDITIONAL_FEW_SHOT_CORPUS_PATH} \
...
#     --src_lang_name ${SRC_LANG_NAME} \
#     --tgt_lang_name ${TGT_LANG_NAME} \
#     --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engwyc2018-dhao/parallel_nt" \
#     --prompt "dhao_post_editing" \
#     --few_shot_mode "parallel" \
#     --vectorizer "word_parallel" \
#     --few_shot_corpus_path ${FEW_SHOT_CORPUS_PATH} \
...
#     --src_lang_name ${SRC_LANG_NAME} \
#     --tgt_lang_name ${TGT_LANG_NAME} \
#     --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engwyc2018-dhao/parallel_full+nt" \
#     --prompt "dhao_post_editing" \
#     --few_shot_mode "parallel" \
#     --vectorizer "word_parallel" \
#     --few_shot_corpus_path ${FEW_SHOT_CORPUS_PATH} ${ADDITIONAL_FEW_SHOT_CORPUS_PATH} \
