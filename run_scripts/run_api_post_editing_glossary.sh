...
python run_post_editing.py \
    ...
    --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engBBE-dhao/glossary" \
...
python run_post_editing.py \
    ...
    --src_lang_name ${SRC_LANG_NAME} \
    --tgt_lang_name ${TGT_LANG_NAME} \
    --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-engBBE-dhao/glossary_full" \
    --prompt "dhao_post_editing" \
    --few_shot_mode "glossary" \
    --glossary_mode "full" \
    --glossary_path ${GLOSSARY_PATH} \
...
python run_post_editing.py \
    ...
    --src_lang_name ${SRC_LANG_NAME} \
    --tgt_lang_name ${TGT_LANG_NAME} \
    --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-webp-dhao/glossary" \
    --prompt "dhao_post_editing" \
    --few_shot_mode "glossary" \
    --glossary_mode "word_fuzzy" \
    --glossary_path ${GLOSSARY_PATH} \
