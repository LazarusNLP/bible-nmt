...
echo "========================================"
echo "COMMAND 1: Translation with Few-Shot (Parallel + Glossary)"
echo "========================================"
python run_post_editing.py \
    ...
    --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-translation-webp-dhao/llm+fewshot_glossary_parallel" \
...
echo ""
echo "========================================"
echo "COMMAND 2: LLM-Only Translation (No Few-Shot)"
echo "========================================"
python run_post_editing.py \
    --model_type "gemini" \
    --model_name "gemini-2.5-flash" \
    ...
    --src_lang_name ${SRC_LANG_NAME} \
    --tgt_lang_name ${TGT_LANG_NAME} \
    --output_dir "${BASE_OUTPUT}/gemini-2.5-flash-translation-webp-dhao/llm_only" \
    --prompt "dhao_translation" \
    --few_shot_mode "none" \
    --batch_size 100 \
    --delay_between_batches 5.0 \
